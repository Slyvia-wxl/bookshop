...
<c:forEach items="${cartItemList }" var="cartItem">
	...
	<tr>
		<td colspan="6"><span style="font-weight: 900">收货地址</span>
		<input id="addr" type="text" name="address" value="${cartItem.address }"/></td>
	</tr>
	<tr>
		<td style="border-bottom:none;" colspan="5" align="right">
			<div class="button cart_button"><a id="linkSubmit" href="javascript:$('#form1').submit();">提交订单</a></div>
		</td>
	</tr>
</table>
</form>
